...
class Dater
{
	...
	public function getTimeZone()
	{
		...
		if ($timezone === 0 || $timezone == 'Автоматически') {
			if(isset($_COOKIE['timezone'])) {
				$timezone = -1 * (int) $_COOKIE['timezone'];
			}

			$timezone = $this->getTZ($timezone);
		}
	...
	public function timeZoneFullList()
	{
		$fulllist = [
		    "Africa/Abidjan" => 0,
		    "Africa/Accra" => 0,
	...
	public function timeZoneShortList()
	{
		$shortlist = [
			"Автоматически" => '',
		    "Pacific/Midway" => -11,			
	...
	public function getTZ($tz)
	{
		$list = $this->timeZoneShortList();
		$timezone = array_search($tz, $list);
		if ($timezone)
			return $timezone;
		else
			return "UTC";
